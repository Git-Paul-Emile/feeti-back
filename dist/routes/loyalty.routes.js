...
router.post("/actions/attendance", authenticate, requireRole("controller", "organizer", "admin", "super_admin"), loyaltyController.onEventAttendance);
router.post("/actions/ticket-purchase", authenticate, requireRole("admin", "super_admin"), loyaltyController.onTicketPurchase);
router.post("/actions/vip-access", authenticate, requireRole("controller", "organizer", "admin", "super_admin"), loyaltyController.grantVipAccess);
