 ...
 */
export const getStreamingEvents = controllerWrapper(async (_req, res) => {
    ...
    res.status(StatusCodes.OK).json(jsonResponse({ status: "success", message: "Événements streaming récupérés", data: mapped }));
});
